    ...
    <body>
        ...
        <div class="container-form">
            ...
            <div class="form-field">
                <p>Your Name</p>
            <input type="text" placeholder="Your Name" name="bookingName">
            </div>
            <div class="form-field">
            <p>Your email</p>
            <input type="email" placeholder="Your email" name="bookingEmail">
            </div>
            <div class="form-field">
            <p>Contact Number</p>
            <input type="text" placeholder="Your phone number" name="bookingPhone">
            </div>
            <div class="form-field">
            <p>Date</p>
            ...
            <a  id="centerDetail" style="display: none;" href="#">Center Detail</a>
            
            <div class="form-field">
            <p>Total Amount:</p>
            <input type="text" style=" border: none; background: transparent; font-size:25px; text-decoration: underline;" readonly  name="amount" id="amount"  value=<%= center0.getPrice()%> />
            </div>
            ...
            <%
                ...
                out.println("var myValue = JSON.parse(center.value);"
                        ...
                        + "amount = trainerPrice + centerPrice;"
                        + "document.getElementById('amount').value = amount;"
                        + "document.getElementById('centerDetail').href=`GymVenueController?action=centerDetail&id=${myValue.centerID}`;");
                out.println("}");
                out.println("</script>");
