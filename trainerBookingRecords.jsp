...
<html>
    ...
    <center><h1>Booking Record of Gym Venue</h1></center>
               ...
               if(bookings.size() != 0){
                   for(int i =0; i <bookings.size();i++){
                       ...
                       if(b.getState().equals("confirmed")){
                           ...
                           out.println("<div class='table-data'><a href='BookingController?action=confirmBooking&BookingID=" + b.getBookingID() + "&TrainerID=" + b.getTrainerID()+ "'>confirm</a> / <a href='BookingController?action=declineBooking&BookingID=" + b.getBookingID() + "&TrainerID=" + b.getTrainerID()+ "'>decline</a></div>");
                       }
                       out.println("</div>");
                   }
                 }else{
